...
class GoldenSapphire extends React.Component {
...
<div className="left-column-single">
    ...
    <img className="active" src={require(`../assets/Images/products/Golden-Sapphire-3.png`)} alt="" />
</div>
