...
class TigersEye extends React.Component {
...
<div className="left-column-single">
    ...
    <img className="active" src={require(`../assets/Images/products/Product-8.png`)} alt="" />
</div>
...
<div className="right-column">
    ...
    <div className="product-description">
        ...
        <h1>Special Edition "Tigers Eye" Balaclava</h1>
    </div>
{/* 
     Product Pricing  */}
